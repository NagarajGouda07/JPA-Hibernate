        ...
        <div class="col-md-6">
            <div class="form-container">
                ...
                <form action="signup" method="post">
                    ...
                    <div class="form-group">
                        <label for="altPhhoneNo">Alternate Phone Number</label>
                        <input type="text" class="form-control" id="altPhhoneNo" name="altPhhoneNo" placeholder="Enter alternate phone number" onblur="validData(event)">
                        <span id="altPhhonevalid"></span>
                    </div>
                    <div class="form-group">
...
const validData=(event)=>{
    ...
    if(name==="altPhhoneNo" && value.length==10){
        console.log("altphhoneNo valid");
        document.getElementById("altPhonevalid").innerHTML="<span}></span>"
    }
    else if(name==="altPhhoneNo" && value.length!=10){
    console.log("altphhoneNo invalid");
